...
import { DashboarLayoutComponent } from './presentation/layouts/dashboarLayout/dashboarLayout.component';
...
export const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				path: 'pros-cons',
				loadComponent: () =>
					import('./presentation/pages/prosConstPage/prosConstPage.component'),
				data: {
...

			{
				path: 'assistant',
				loadComponent: () =>
					import('./presentation/pages/assistentPage/assistentPage.component'),
				data: {
